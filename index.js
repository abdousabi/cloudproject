...
function displayUsernames(usernames) {
    const usernamesContainer = document.getElementById('usernames'); // Élément où afficher les noms d'utilisateur
    usernamesContainer.innerHTML = ''; // Effacer le contenu précédent

    const userList = document.createElement('ul'); // Créer une liste non ordonnée pour afficher les noms d'utilisateur
    ...
    usernames.forEach(username => {
        ...
        userList.appendChild(usernameItem); // Ajouter l'élément de liste à la liste non ordonnée
    });

    usernamesContainer.appendChild(userList); // Ajouter la liste non ordonnée à la section des noms d'utilisateur
}

// Fonction pour afficher tous les sujets sur la page web
function displaySubjects(subjects) {
    const subjectsContainer = document.getElementById('subjects'); // Élément où afficher les sujets
    subjectsContainer.innerHTML = ''; // Effacer le contenu précédent

    const subjectList = document.createElement('ul'); // Créer une liste non ordonnée pour afficher les sujets
